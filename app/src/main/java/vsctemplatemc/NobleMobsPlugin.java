...
import vsctemplatemc.citizens.CitizenInteractionListener;
...
public class NobleMobsPlugin extends JavaPlugin {
    ...
    public void onEnable() {
        ...
        getServer().getPluginManager().registerEvents(new CitizenInteractionListener(citizenRegistry, shopService), this);
